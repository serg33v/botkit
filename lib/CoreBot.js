                ...
                if (this.handler) {
                    ...
                    if (this.messages.length) {
                        ...
                        if (this.isActive() && !this.messages.length && !this.handler) {
                            botkit.debug('minus tick');
                            this.tickCounter--;
                        }
                        if (this.isActive() && !this.messages.length && !this.handler && this.tickCounter <= 0) {
                    ...
                    } else if (this.sent.length && this.tickCounter <= 0) { // sent at least 1 message
                        this.status = 'completed';
                        botkit.debug('Conversation is over!');
                        this.tickCounter = 10;
                        this.task.conversationEnded(this);
